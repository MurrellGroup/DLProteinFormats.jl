...
Categorizer(a::AbstractDict) = Categorizer(a, maximum(values(a)))

bin(v, a::AbstractVector) = searchsortedfirst(vcat(a, [Inf]), v)

categorize(v::Union{Nothing,Missing}, d::Categorizer) = d.default
categorize(v::Union{Number,AbstractString,Char,Symbol}, d::Categorizer{<:Dict}) = get(d.cats, v, d.default)
categorize(v::Union{Number,AbstractString,Char,Symbol}, d::Categorizer{<:Function}) = d.cats(v)
